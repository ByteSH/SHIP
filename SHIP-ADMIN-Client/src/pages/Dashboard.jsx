  ...
  return (
    <div className="vh-100 d-flex flex-column overflow-hidden" style={{ backgroundColor: '#F4F7FE', padding: '0.5rem 2rem', fontFamily: "'Segoe UI', Roboto, sans-serif" }}>
      ...
      <div className="d-flex flex-column flex-md-row flex-grow-1 overflow-hidden gap-3 pb-2 w-100">
        ...
        <div className="col-12 col-md-4 col-lg-3 p-0 h-md-100">
          <div 
          ...
          >
            ...
            <div className="d-flex gap-3 flex-wrap mb-4">
              ...
              >
                ...
                <span className="fw-bold" style={{ fontSize: '0.75rem', color: '#A3AED0' }}>Create User</span>
              </div>
              ...
              >
                ...
                <span className="fw-bold" style={{ fontSize: '0.75rem', color: '#A3AED0' }}>Edit User</span>
              </div>
              ...
              >
                ...
                <span className="fw-bold" style={{ fontSize: '0.75rem', color: '#A3AED0' }}>Get User</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-8 col-lg-9 p-0 h-md-100 flex-grow-1">
          <div 
